...
public class UndoLogController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("warehouse:undolog:list")
    ...
    // @RequiresPermissions("warehouse:undolog:info")
     ...
     */
    @RequestMapping("/save")
    // @RequiresPermissions("warehouse:undolog:save")
    ...
    // @RequiresPermissions("warehouse:undolog:update")
    ...
    // @RequiresPermissions("warehouse:undolog:delete")
